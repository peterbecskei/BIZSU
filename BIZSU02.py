...
#{'productNumber': None, 'CikkKod': 'LEM 3033701 *BR', 'Keszlet': 'B', 'Gyarto': 'LEMFÖRDER', 'KiskerAr': '17770.6386', 'TCD_ID': '35', 'ArDatum': '2025-09-18 21:52:46', 'RefeKeszlet': 'I', 'AlapEgys': '1', 'Suly': '0',
        ...
        #print(extracted['productNumber'] ,extracted['CikkKod'], extracted['Keszlet'], extracted['br_price'],extracted['Gyarto'], extracted['KiskerAr'], extracted['ArDatum'], extracted['RefeKeszlet'], extracted['CnevText'], extracted['TCD_ARTNR'] , extracted['TCD_ID'] , extracted['TCD_ID'] )
